package com.sulake.habbo.communication.messages.outgoing.userdefinedroomevents {
    ...
    public class UpdateVariableMessageComposer implements IMessageComposer, IDisposable {

        public function UpdateVariableMessageComposer(param1: int, param2: Array, param3: Array, param4: String, param5: Array, param6: Array, param7: Array) {
            var_20 = [];
            super();
            var_20.push(param1);
