package com.sulake.habbo.communication.messages.outgoing.room.layout {
   ...
   [SecureSWF(rename="true")]
    public class class_932 implements IMessageComposer {

        public function class_932(param1: String, param2: int = -1, param3: int = -1, param4: int = -1, param5: int = -1, param6: int = -1, param7: int = -1) {
            super();
