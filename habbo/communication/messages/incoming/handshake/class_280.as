package com.sulake.habbo.communication.messages.incoming.handshake {
    ...
    public class class_280 extends MessageEvent implements IMessageEvent {
        ...
        public function class_280(param1: Function) {
        ...
        public function getReasonName(): String {
            ...
            if (var_647 == null) {
                ...
                _loc2_ = describeType(class_280);
                for each(var _loc1_ in _loc2_.constant) {
                    _loc3_ = _loc1_.@name;
                    _loc4_ = String(class_280[_loc1_.@name]);
