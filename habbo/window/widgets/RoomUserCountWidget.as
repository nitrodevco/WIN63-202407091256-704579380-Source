package com.sulake.habbo.window.widgets
{
   ...
   public class RoomUserCountWidget implements IRoomUserCountWidget
   {
      ...
      public function RoomUserCountWidget(param1:IWidgetWindow, param2:HabboWindowManagerComponent)
      {
         super();
         var_1759 = param1;
         _windowManager = param2;
         var_509 = _windowManager.buildFromXML(_windowManager.assets.getAssetByName("room_user_count_xml").content as XML) as IWindowContainer;
