package com.sulake.habbo.phonenumber
{
   ...
   public class VerificationCodeInputMinimizedView
   {
      ...
      private function createWindow() : void
      {
         ...
         _window = var_1660.windowManager.buildFromXML(XML(var_1660.assets.getAssetByName("phonenumber_verify_minimized_xml").content));
      ...
      {
         var_1660.setVerifyViewMinimized(false);
      }
