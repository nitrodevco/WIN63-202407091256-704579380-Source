package com.sulake.habbo.roomevents.wired_setup.variables
{
   ...
   public class class_3796 extends DefaultVariableType
   {
      ...
      override public function onEditStart(param1:class_1659) : void
      {
         ...
         questChainNameTxt.text = _loc2_.length > 1 ? _loc2_[1] : "";
      }
      
      override public function readStringParamFromForm() : String
      {
         return variableNameTxt.text + STRING_PARAM_SPLITTER + questChainNameTxt.text;
      }
      ...
      private function get questChainNameTxt() : ITextFieldWindow
      {
         return ITextFieldWindow(_cont.findChildByName("quest_chain_name"));
      }
