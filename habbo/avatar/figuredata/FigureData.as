package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureData implements IAvatarImageListener
   {
      ...
      private var var_1631:FigureDataView;
      ...
      public function FigureData(param1:HabboAvatarEditor)
      {
         ...
         var_1631 = new FigureDataView(this);
      }
      ...
      {
         var_1631.update(getFigureString(),var_1603,var_1210);
      }
