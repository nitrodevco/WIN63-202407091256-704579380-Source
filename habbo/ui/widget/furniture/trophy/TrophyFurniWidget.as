package com.sulake.habbo.ui.widget.furniture.trophy
{
   ...
   public class TrophyFurniWidget extends RoomWidgetBase implements ITrophyFurniWidget
   {
      ...
      public function TrophyFurniWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:ICoreConfiguration)
      {
      ...
      private function updateInterface() : void
      {
         ...
         switch(var_4070 - 10)
         {
            case 0:
            case 10:
               var_1631 = new NikoTrophyView(this,var_4070);
               break;
            default:
