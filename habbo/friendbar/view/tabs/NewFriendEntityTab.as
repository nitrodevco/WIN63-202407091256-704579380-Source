package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class NewFriendEntityTab extends Tab
   {
      ...
      private static const const_518:String = "new_friend_entity_xml";
      ...
      private static const const_422:Vector.<NewFriendEntityTab> = new Vector.<NewFriendEntityTab>();
      ...
      {
         var _loc2_:NewFriendEntityTab = const_422.length > 0 ? const_422.pop() : new NewFriendEntityTab();
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            ...
            if(friend.online)
            {
               (_loc6_ = WINDOWING.buildFromXML(ASSETS.getAssetByName("new_controls_piece_xml").content as XML) as IWindowContainer).name = "controls";
      ...
      {
         var _loc1_:IWindowContainer = const_420.length > 0 ? const_420.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName("new_friend_entity_xml").content as XML) as IWindowContainer;
